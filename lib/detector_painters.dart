...
class BarcodeDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Barcode barcode in barcodes) {
      ...
      canvas.drawRect(
        _scaleRect(
          rect: barcode.value.boundingBox!,
          imageSize: imageSize,
          widgetSize: size,
        ),
        paint,
...
class LabelDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Label label in labels) {
      builder.addText('Label: ${label.getText()}, '
          'Confidence: ${label.getConfidence().toStringAsFixed(2)}\n');
    }
    builder.pop();
...
class TextDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect _getRect(dynamic container) {
      return _scaleRect(
        rect: container.rect,
        imageSize: imageSize,
        widgetSize: size,
